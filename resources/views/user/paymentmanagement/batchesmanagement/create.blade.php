...
@section('title')
    <title>Damcon ERP - Batches Management Create</title>
@endsection
{{-- back btn --}}
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('batches_management.store')}}"  method="post" class="import_purchases" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-4 col-12" >
                                    <div class="form-group">
                                        <label>Name of Batch<span class="red_asterik"></span></label>
                                        <input type="text"  name="name_of_batch" class="form-control" placeholder="Name of Batch" value="{{ old('name_of_batch') }}" required/>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 banks" name="bank_id">
                                            ...
                                            @foreach ($bankaccounts as $item)
                                                <option value="{{$item->id}}" {{ old('sender_bank_id') == $item->id ? "selected" : "" }}>{{$item->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off"  name="date_of_creation" class="form-control date_of_creation" placeholder="Date of Creation" value="{{ old('date_of_creation') }}" readonly required/>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="position-relative form-group">
                                                                <input type="checkbox" class="salary_checkbox" data-amount="{{$val->amount}}"  />
                                            ...
                                            <tbody>
                                                @foreach ($advanceHr as $val)
                                                    <tr>
                                                        <td>
                                                            <div class="position-relative form-group">
                                                                <input type="checkbox" class="advance_checkbox"  data-amount="{{$val->amount}}" />
                                            ...
                                            <tbody>
                                                @foreach ($supplier_payment as $val)
                                                    <tr>
                                                        <td>
                                                            <div class="position-relative form-group">
                                                                <input type="checkbox" class="supplier_checkbox" data-amount="{{$val->amount}}"  />
                                            ...
                                            <tbody>
                                                @foreach ($security_payment as $val)
                                                    <tr>
                                                        <td>
                                                            <div class="position-relative form-group">
                                                                <input type="checkbox" class="securitypayment_checkbox" data-amount="{{$val->amount}}"  />
...
@section('scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            $('.advance_checkbox').change(function(){
                ...
                if ($(this).is(':checked')) {
                    ...
                    $(this).closest('tr').find('.advancehrids').prop('disabled', !this.checked);


                    totalamount += Number(amount);

                    amount_val.val(totalamount);
            ...
            $('.salary_checkbox').change(function(){
                ...
                if ($(this).is(':checked')) {
                    ...
                    $(this).closest('tr').find('.salariesids').prop('disabled', !this.checked);
            ...
            $('.supplier_checkbox').change(function(){
                ...
                if ($(this).is(':checked')) {
                    ...
                    $(this).closest('tr').find('.supplierpaymentids').prop('disabled', !this.checked);
            ...
            $('.securitypayment_checkbox').change(function(){
                ...
                if ($(this).is(':checked')) {
                    ...
                    $(this).closest('tr').find('.securitypaymentids').prop('disabled', !this.checked);
