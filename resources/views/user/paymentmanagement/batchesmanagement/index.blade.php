...
@section('title')
    <title>Damcon ERP -  View Batches Management</title>
@endsection
@section('content')
    @include('alert.alert')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Batches Management</h4>

            <a href="{{ route('batches_management.create') }}" class="create-btn"><i data-feather='plus'></i> Add </a>
            ...
            var table = $('.batches_table').DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        filename:"Batches Management Data",
                    }
                ],
                processing: true,
                serverSide: true,
                ajax: "{{ route('batches_management.index') }}",
                columns: [
                    {data: 'checkbox', name: '#'},
                    {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    {data: 'name_of_batch', name: 'name_of_batch'},
                    {data: 'bank_name', name: 'bank_name'},
                    {data: 'date_of_creation', name: 'date_of_creation'},
                    {
                        data: 'action',
                        name: 'action',
                        orderable: true,
