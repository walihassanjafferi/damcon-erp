...
@section('title')
    <title>Damcon ERP - Quality Health Safety</title>
@endsection
@section('content')
    @include('alert.alert')
    <style>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Quality Health Safety Event</h4>

            <a href="{{ route('qualityhealthSafety.create') }}" class="create-btn"><i data-feather='plus'></i> Add Quality Health Safety</a>

            <p class="card-text">
            <table class="table table-striped table-bordered qhs_table" style="width:100%" id="qhs_table">
                <thead>
                <tr>
                    <th></th>
                    <th>#</th>
...
@section('scripts')
    <script>
        $(document).ready( function () {
            ...
            $('#qhs_table tbody').on( 'click', 'tr', function () {
