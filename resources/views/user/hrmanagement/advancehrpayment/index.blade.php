...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Advance HR Payment</h4>

            <a href="{{ route('advancehrpayment.create') }}" class="create-btn"><i data-feather='plus'></i> Add Advance</a>
    ...
    <script>
        $(document).ready( function () {
            ...
            var table = $('.increment_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('getAjaxAdvanceHrPayment') }}",
                columns: [
                    {data: 'checkbox', name: '#'},
                    {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    {data: 'name', name: 'name'},
                    {data: 'damcon_employee_id', name: 'damcon_employee_id'},
                    {data: 'cnic', name: 'cnic'},
