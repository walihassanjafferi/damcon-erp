...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Employee Exit Management</h4>

            <a href="{{ route('employeeExitManagement.create') }}" class="create-btn"><i data-feather='plus'></i> Add Employee Exit Management</a>
        ...
        $(document).ready( function () {
            ...
            var table = $('.qhs_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'settlement_month', name: 'settlement_month'},
                    {
                        data: 'action',
                        name: 'action',
                        orderable: true,
