...
@section('title')
<title>Damcon ERP - Edit HR-Categories</title>
@endsection
{{-- back btn --}}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit HR Category</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('hrcategories.update',encrypt($category->id))}}"  method="post">
                        @csrf @method('PATCH')
                        ...
                        <div class="row">
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_name" class="form-control" value="{{ $category->category_name }}" placeholder="Category" required/>
                                </div>
                            </div>
