...
@section('title')
<title>Damcon ERP - Add Increment Management</title>
@endsection
{{-- back btn --}}
@section('main_btn_href') {{route('increment-management.index')}} @endsection
@section('main_btn_text') All Increments Management @endsection
{{-- back btn --}}
@section('content')
@include('alert.alert')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Increment</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('increment-management.store')}}"  method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="current_basic_salary" class="form-control current_basic_salary" value="{{ old('current_basic_salary') }}" placeholder="Basic Salary" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="current_medical_allowance" class="form-control current_medical_allowance" value="{{ old('current_medical_allowance') }}" placeholder="Current Medical Allowance" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="current_mobile_allowance" class="form-control current_mobile_allowance" value="{{ old('current_mobile_allowance') }}" placeholder="Current Mobile Allowance" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="current_laptop_bonus" class="form-control current_laptop_bonus" value="{{ old('current_laptop_bonus') }}" placeholder="Current Laptop Bonus" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="current_conveyance_allowance" class="form-control current_conveyance_allowance" value="{{ old('current_conveyance_allowance') }}" placeholder="Current Conveyance Allowance" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="current_other_allowance" class="form-control current_other_allowance" value="{{ old('current_other_allowance') }}" placeholder="Current Other Allowance" readonly/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="new_basic_salary" class="form-control new_basic_salary" value="{{ old('new_basic_salary') }}" placeholder="New Basic Salary" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="new_medical_allowance" class="form-control new_medical_allowance" value="{{ old('new_medical_allowance') }}" placeholder="New Medical Allowance" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="new_mobile_allowance" class="form-control new_mobile_allowance" value="{{ old('new_mobile_allowance') }}" placeholder="New Mobile Allowance" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="new_laptop_bonus" class="form-control new_laptop_bonus" value="{{ old('new_laptop_bonus') }}" placeholder="New Laptop Bonus" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="new_conveyance_Allowance" class="form-control new_conveyance_Allowance" value="{{ old('new_conveyance_Allowance') }}" placeholder="New Conveyance Allowance" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="new_other_allowance" class="form-control new_other_allowance" value="{{ old('new_other_allowance') }}" placeholder="New Other Allowance" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label>New Basic Salary</label>
                                    <input type="number" name="inc_basic_salary" class="form-control inc_basic_salary" value="{{ old('inc_basic_salary') }}" placeholder="New Basic Salary" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label>New Medical Allowance</label>
                                    <input type="number" name="inc_medical_allowance" class="form-control inc_medical_allowance" value="{{ old('inc_medical_allowance') }}" placeholder="New Medical Allowance" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label>New Mobile Allowance</label>
                                    <input type="number" name="inc_mobile_allowance" class="form-control inc_mobile_allowance" value="{{ old('inc_mobile_allowance') }}" placeholder="New Mobile Allowance" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label>New Laptop Bonus</label>
                                    <input type="number" name="inc_laptop_bonus" class="form-control inc_laptop_bonus" value="{{ old('inc_laptop_bonus') }}" placeholder="New Laptop Bonus" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label>New Conveyance Allowance</label>
                                    <input type="number" name="inc_conveyance_Allowance" class="form-control inc_conveyance_Allowance" value="{{ old('inc_conveyance_Allowance') }}" placeholder="New Conveyance Allowance" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label>New Other Allowance</label>
                                    <input type="number" name="inc_other_allowance" class="form-control inc_other_allowance" value="{{ old('inc_other_allowance') }}" placeholder="New Other Allowance" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_increment" class="form-control total_increment" value=0 placeholder="Total Increment" readonly/>
                                </div>
                            </div>
