...
@section('title')
    <title>Damcon ERP -  Increment Management</title>
@endsection
@section('content')
    @include('alert.alert')
    <style>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Increment Management</h4>

            <a href="{{ route('increment-management.create') }}" class="create-btn"><i data-feather='plus'></i> Add Increment</a>

            <p class="card-text">
            <table class="table table-striped table-bordered increment_table" style="width:100%" id="increment_table">
                <thead>
                <tr>
                    <th></th>
                    <th>#</th>
        ...
        $(document).ready( function () {
            ...
            var table = $('.increment_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'new_basic_salary', name: 'new_basic_salary'},
                    {
                        data: 'action',
                        name: 'action',
                        orderable: true,
            ...
            $('#increment_table tbody').on( 'click', 'tr', function () {
