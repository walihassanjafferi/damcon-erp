            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Assets Purchase Order</h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('assetspos.store')}}"  method="post" class="import_purchases" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        <label>Purchase Title<span class="red_asterik"></span></label>
                                        <input type="text"  name="purchase_title" class="form-control" placeholder="Purchase Title" value="{{ old('purchase_title') }}" required/>
                                    </div>
                                </div>
                                ...
                                {{-- <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        NULL, ['class' => 'form-control select2 select_asset','required'=>'true']) !!}
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <select name="payment_terms" class="form-control" required>
                                            ...
                                            <option value="3">Monthly Installment</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off"   name="sales_tax_wh" class="form-control sales_tax_wh" placeholder="Sales Tax WH" value="{{ old('sales_tax_wh') }}" required readonly/>
                                    </div>
                                </div>
        ...
        $(function(){
            ...
            $('.add_variation').click(function name(params) {
               ...
               // items_list=[];
                ...
                content +='<select class="form-control select2 item_dropdown_append inventory_item" name="item_name[]" onChange="getPrice(event,'+increment+')">';
                ...
                $.each(items,function(key,value){
                    ...
                    content += '<option value='+value.id+'  '+check_list+'>'+value.asset_item_id+' ( '+value.registration_no+' ) '+'</option>';
                });
                content +='</select>';
