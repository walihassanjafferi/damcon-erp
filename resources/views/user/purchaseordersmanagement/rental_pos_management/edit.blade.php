            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update Rental Purchase Order</h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('rentalpos.update',encrypt($rental_order->id))}}"  method="post" class="import_purchases" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="purchase_od_number" class="form-control" placeholder="Purchase Order Number" value="{{ $rental_order->purchase_od_number }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="agreement_number" class="form-control" placeholder="Agreement Number" value="{{ $rental_order->agreement_number }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control" required>
                                            <option @if($rental_order->type == 1){{ 'selected' }}@endif value="1">Services</option>
                                            <option @if($rental_order->type == 2){{ 'selected' }}@endif value="2">Parts</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        $rental_order->supplier_id, ['class' => 'form-control select2 select_supplier','required'=>'true']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        $rental_order->project_id, ['class' => 'form-control select2 select_project','required'=>'true']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="customer_optional_number" class="form-control" placeholder="Customer Optional Number" value="{{ $rental_order->customer_optional_number }}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" tabindex="-1" name="issue_date" class="form-control issue_date form-date" placeholder="Issue Date" value="{{ $rental_order->issue_date }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" tabindex="-1"  name="purchase_order_month" class="form-control purchase_order_month form-date" placeholder="Purchase Order Month" value="{{ $rental_order->purchase_order_month }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        <label>Region</label>
                                        <input type="text" autocomplete="off"   name="region" class="form-control" placeholder="Region" value="{{ $rental_order->region }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        $rental_order->tax_body_id, ['class' => 'form-control select2 tax_id','required'=>'true','onchange'=>'fetch_tax__body_percentage()','id'=>'tax_body']) !!}
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off"   name="taxation_month" class="form-control taxation_month_date form-date" placeholder="Taxation Month" value="{{ $rental_order->taxation_month }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off"   name="tax_body_percentage" id="tax_body_percentage" class="form-control" placeholder="Tax Body %" value="{{ $rental_order->tax_body_percentage }}" readonly required/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off"   name="sales_tax_wh" class="form-control" placeholder="Sales Tax WH" value="{{ $rental_order->sales_tax_wh }}" required readonly/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off"   name="supplier_tax_deduction_1" class="form-control" placeholder="Supplier withheld Tax Deduction 1(%)" value="{{ $rental_order->supplier_tax_deduction_1 }}" required readonly/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off"   name="supplier_tax_deduction_2" class="form-control" placeholder="Supplier withheld Tax Deduction 2(%)" value="{{ $rental_order->supplier_tax_deduction_2 }}" required readonly/>
                                    </div>
                                </div>
                                ...
                                <table class="table variations_table col-12" id="items_table">
                                    ...
                                    <tbody>
                                    @if(!$rental_order_items->isEmpty())
                                        @foreach ($rental_order_items as $item)
                                            <tr>
                                                <td>
                                                    <div class="position-relative form-group">
                                                        <label  class="">Item Name</label>
                                                        <input type="text"  name="item_name[]" readonly value="{{ $item->items->rental_name ?? '' }}"  class="form-control"   required/>
                                                        <input type="text"  name="item_ids[]" hidden value="{{ $item->items->id ?? '' }}"  class="form-control"   required/>
                                                ...
                                                <td>
                                                    <div class="position-relative form-group ">
                                                        ...
                                                        <input name="item_quantity[]" readonly value="{{ $item->qty }}" type="number" class="form-control price" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="position-relative form-group ">
                                                        <label for="price" class="required">Item Monthly Rent</label>
                                                        <input name="item_monthly_rent[]" readonly type="number" value="{{ $item->cost }}" class="form-control price" required>
                                                    </div>
                                                </td>
                                                {{-- <td>
                                        ...
                                        @endforeach
                                    @endif
                                    @if(old('item_name') && old('item_quantity') && old('item_monthly_rent'))
                                        ...
                                        @for( $i =0; $i < count(old('item_name')); $i++)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="position-relative form-group ">
                                                        <label for="price" class="required">Item Monthly Rent</label>
                                                        <input name="item_monthly_rent[]" type="number" value="{{ old('item_monthly_rent.'.$i)}}" class="form-control price" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <button class="btn btn-secondary delete_variation_row" onclick="delete_item()">
                                ...
                                <div class="col-md-12 mb-2 mt-2">
                                    ...
                                    <textarea class="form-control" name="comments" rows="5" required>{{ $rental_order->comments }}</textarea>
                                </div>
    ...
    <script>
        ...
        $(function(){
            ...
            $('.add_variation').click(function name(params) {
                ...
                content +='<select class="form-control select2 item_dropdown_append inventory_items abc" name="item_ids[]" onChange="getPrice(event,'+increment+')">';
