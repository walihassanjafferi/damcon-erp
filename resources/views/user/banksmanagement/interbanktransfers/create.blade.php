...
@section('title')
<title>Damcon ERP - Create Interbank transfers</title>
@endsection
{{-- back btn --}}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Inter-Bank transfer</h4>
                </div>
                <div class="card-body">
                   {!! Form::open(['route' => 'interbanktransfer.store']) !!}
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('transaction_date', null, ['class' => 'form-control','required','id'=>'transaction_date','readonly']) !!}
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    null, ['class' => 'form-control','id'=>'transaction_type']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    {{-- {!! Form::select('sender_bank_id',[null=>'Select Sender bank']+$banks+('anbc'),
                                    null, ['class' => 'form-control select2 banks','id'=>'sender_Bank']) !!} --}}
                                    <select class="form-control select2 banks" name="sender_bank_id">
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('amount', null, ['class' => 'form-control avaliable_balance amount_format','required']) !!}
                            ...
                            {{-- <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    null, ['class' => 'form-control select2 banks','id'=>'receiver_bank']) !!}
                                    <span class="error-help-block"></span>    
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    {{ old('receiver_bank_id')}}
                                    <label>Receiver Bank<span class="red_asterik"></span></label>
                                   
                                    <select class="form-control select2 banks" name="receiver_bank_id">
                                        @foreach ($banks as $item)
                                            <option value="{{$item->id}}" {{ old('receiver_bank_id') == $item->id ? "selected" : "" }}>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                    <span class="error-help-block"></span>    
                            </div>
