...
@section('title')
<title>Damcon ERP -  Edit Project</title>
@endsection
{{-- back btn --}}
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::model($project, ['route' => ['projectmanagement.update', encrypt($project->id)],'method' => 'PATCH']) !!}
                    <div class="row">
                            ...
                            {{-- <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('customer_project_manager_contact_no', null, ['class' => 'form-control','required']) !!}
                                </div>
                            </div> --}}
                            ...
                            {{-- <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('damcon_project_manager_contact_no', null, ['class' => 'form-control','required']) !!}
                                </div>
                            </div> --}}
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('project_start_date', null, ['class' => 'form-control','required','id'=>'project_start_date']) !!}
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    {{-- <input type="text" id="project_start_date"  name="project_start_date" class="form-control" placeholder="Start Date"  required/> --}}
                                    {!! Form::text('project_end_date', null, ['class' => 'form-control','required','id'=>'project_end_date']) !!}
