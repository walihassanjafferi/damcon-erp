@extends('layout.main')
@section('inventorycategory_sidebar_parent') active @endsection
@section('title')
<title>Damcon ERP - Add Categories</title>
@endsection
{{-- back btn --}}
@section('main_btn_href') {{route('itemscategories.index')."?category_level=parent-category&module_name=project_item"}} @endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('itemscategories.store')}}"  method="post">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="module_name" class="module_name" hidden value="project_item" />
                            ...
                            <div class="col-md-4 col-12 categories_select">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="category_type" id="category_type">
                                        ...
                                        <option value="sub_sub">Sub Child Category</option>
                                    </select>
                            ...
                            <div class="col-md-4 col-12 parent_categories_1" style="display: none;">
                                <div class="form-group">
                                     ...
                                     "{{ old('parent_categories') }}", ['class' => 'form-control p_categories select2','required'=>'true']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12 main_categories" style="display: none;">
                                <div class="form-group">
                                     ...
                                     "{{ old('main_categoriess') }}", ['class' => 'form-control main_categories_1 select2','required'=>'true']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-12 sub_sub_category_value" style="display: none;">
                                <div class="form-group">
    ...
    $(function(){
        ...
        $('.categories_select').change(function(){
            ...
            function getAjaxCategories(module_name,category_select) {
                ...
                $.ajax({
                    url:'{{ route('ajaxgetcategorybymodule')}}',
                    data: {
                        "_token": "{{ csrf_token() }}",
