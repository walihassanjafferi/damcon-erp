...
@section('inventorycategory_sidebar_child') active @endsection
@endif
@section('title')
...
<div class="card mb-4">
    <div class="card-body">
        @if(request()->get('module_name') == 'project_item')
            <h4 class="card-title">Inventory Categories</h4>
        @endif
        
        <a href="{{ route('itemscategories.create') }}/?module_name=project_item" class="create-btn"><i data-feather='plus'></i> Add Category</a>
