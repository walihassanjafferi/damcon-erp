        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Maintenance Items</h4>
                </div>
               
                <div class="card-body">
                    <form action="{{ route('maintenanaceiteminventory.store')}}"  method="post" class="import_purchases">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="service_id" class="form-control" placeholder="Service ID"  value="{{ old('service_id') }}" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                     ...
                                     {!! Form::select('supplier_id',[null=>'Select Supplier']+$suppliers,''
...
<script>
    ...
    function getCategoriesByID(category_id,category_select)
    {
        ...
        var module_name = "maintenance_item";
