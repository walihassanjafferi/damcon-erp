...
@endsection
{{-- back btn --}}
@section('main_btn_href') {{route('itemscategories.index')."?category_level=parent-category&module_name=maintenance_item"}} @endsection
                ...
                <div class="card-body">
                    <form action="{{ route('itemscategories.store')}}"  method="post">
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="module_name" class="module_name" hidden value="maintenance_item" />
