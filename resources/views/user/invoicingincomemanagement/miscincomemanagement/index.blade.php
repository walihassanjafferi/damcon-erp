...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Misc Income Management</h4>

            <a href="{{ route('miscincome.create') }}" class="create-btn"><i data-feather='plus'></i> Add Misc Income</a>

            <p class="card-text">
            <table class="table table-striped table-bordered misc_income_table" style="width:100%" id="misc_income_table">
                <thead>
                <tr>
                    <th></th>
                    <th>#</th>
...
@section('scripts')
    <script>
        $(document).ready( function () {
            ...
            var table = $('.misc_income_table').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: "Project Misc Income",
                        className: 'btn btn-primary',
                        exportOptions: {
                            columns: [  1, 2, 3, 4,5,6,7]
                        },
                        filename:"Project Misc Income",
                    },
                    {
                        extend: 'pdfHtml5',
                        title: 'Project Misc Income',
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('getAjaxMiscIncome') }}",
                columns: [
                    {data: 'checkbox', name: '#'},
                    {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    {data: 'title', name: 'title'},
                    {data: 'project_id', name: 'project_id'},
                    {data: 'check_receiving_date', name: 'check_receiving_date'},
            ...
            $('#misc_income_table tbody').on( 'click', 'tr', function () {
