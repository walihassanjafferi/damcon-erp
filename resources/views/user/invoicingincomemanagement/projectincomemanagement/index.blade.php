...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Project Income Management</h4>

            <a href="{{ route('projectincome.create') }}" class="create-btn"><i data-feather='plus'></i> Add Project Income</a>

            <p class="card-text">
            <table class="table table-striped table-bordered project_income_table" style="width:100%" id="project_income_table">
                <thead>
                <tr>
                    <th></th>
                    <th>#</th>
...
@section('scripts')
    <script>
        $(document).ready( function () {
            ...
            var table = $('.project_income_table').DataTable({
            ...
            $('#project_income_table tbody').on( 'click', 'tr', function () {
