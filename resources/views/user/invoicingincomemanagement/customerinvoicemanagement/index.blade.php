...
@section('title')
    <title>Damcon ERP - Add Customer Invoice Management</title>
@endsection
@section('content')
    @include('alert.alert')
    <style>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Customer Invoice Management</h4>

            <a href="{{ route('customerinvoice.create') }}" class="create-btn"><i data-feather='plus'></i> Add Customer Invoice</a>

            <p class="card-text">
            <table class="table table-striped table-bordered customer_invoice_table" style="width:100%" id="customer_invoice_table">
                <thead>
                <tr>
                    <th></th>
                    <th>#</th>
...
@section('scripts')
    <script>
        $(document).ready( function () {
            ...
            var table = $('.customer_invoice_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('getAjaxCustomerInvoice') }}",
                columns: [
                    {data: 'checkbox', name: '#'},
            ...
            $('#customer_invoice_table tbody').on( 'click', 'tr', function () {
