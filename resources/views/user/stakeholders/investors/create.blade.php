...
@section('title')
<title>Damcon ERP -  Create Investor</title>
@endsection
{{-- back btn --}}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Investors</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-12">
                                <div class="form-group">
                                    <label >Type of Investor<span class="red_asterik"></span></label>
                                    {!! Form::select('type_of_invester', ['profit_making_terms' => 'Investor with profit taking terms', 'zero_markup' => 'Investor with zero markup','company_director'=>'Company Director'],
                                    null, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="state">Description<span class="red_asterik"></span></label>
