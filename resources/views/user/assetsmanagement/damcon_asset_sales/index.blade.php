...
@section('title')
    <title>Damcon ERP -  View Damcon Assets Sales</title>
@endsection
@section('content')
    @include('alert.alert')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Damcon Asset Sale</h4>

            <a href="{{ route('damconassetsales.create') }}" class="create-btn"><i data-feather='plus'></i> Add Assets</a>
...
@section('scripts')
    <script>
        $(document).ready( function () {
            ...
            var table = $('.damcon_assets_table').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Damcon Assets Sales',
                        className: 'btn btn-primary',
                        exportOptions: {
                            columns: [  1, 2, 3, 4,5,6]
                        },
                        filename:"Damcon Assets Sales Data",
                    },
                    {
                        extend: 'pdfHtml5',
                        title: 'Damcon Assets Sales',
        ...
        function deleteOrder(id){
            ...
            swal({
                title: "Are you sure?",
                text: "Once deleted, you will not be able to recover this Damcon Assets Sales",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            ...
            if(List_ID.length>0){
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url:'{{route('assets_sales_bulk_remove')}}',
                                data: {
                                    "_token": "{{ csrf_token() }}",
                                    "order_list":List_ID
                                },
