        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('damconassetsales.store')}}"  method="post" class="import_purchases" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" autocomplete="off" name="last_milage_hours" class="form-control last_milage_hours" placeholder="Last Mileage/Hours" value="{{ old('last_milage_hours') }}"  required />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control avaliable_balance" required=""  name="cheque_no" value="{{ old('cheque_no') }}" type="text">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control sale_price amount_format" required=""  name="sale_price"  value="{{ old('sale_price') }}" type="text">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="sold_party_details" class="form-control" rows="4"  required>{{ old('sold_party_details') }}</textarea>
