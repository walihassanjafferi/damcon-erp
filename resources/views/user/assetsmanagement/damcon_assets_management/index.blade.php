...
@section('title')
    <title>Damcon ERP -  View Damcon Assets Management</title>
@endsection
@section('content')
    @include('alert.alert')
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Damcon Assets Management</h4>

            <a href="{{ route('damconassets.create') }}" class="create-btn"><i data-feather='plus'></i> Add Assets</a>
    ...
    <script>
        $(document).ready( function () {
            ...
            var table = $('.assets_pos_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('damcom_get_assets',['project_id'=>$project_id]) }}",
                columns: [
                    {data: 'checkbox', name: '#'},
