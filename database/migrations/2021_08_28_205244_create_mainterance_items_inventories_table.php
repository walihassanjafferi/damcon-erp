...
class CreateMainteranceItemsInventoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mainterance_items_inventories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mainterance_items_inventories');
    }
}
