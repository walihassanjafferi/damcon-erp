...
trait MaintenancetemsInventoryTraitUpdates {

   public static function maintenanceinventoryUpdate($inventory_id,$date_of_update,$stock_update,$opening_stock,
   ...
   {
        $inventory_updates = new maintenance_items_inventory_updates();

        $inventory_updates->maintenance_item_id = $inventory_id;
